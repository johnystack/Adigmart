...
<main>
    ...
    <section class="gj do ir hj sp jr i pg">
      ...
      <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
        <img src="{{asset('assets/images/shape-01.svg')}}" alt="shape" class="xc 2xl:ud-block h t -ud-left-[10%] ua" />
        <img src="{{asset('assets/images/shape-02.svg')}}" alt="shape" class="xc 2xl:ud-block h u p va" />
        <img src="{{asset('assets/images/shape-03.svg')}}" alt="shape" class="xc 2xl:ud-block h v w va" />
        <img src="{{asset('assets/images/shape-04.svg')}}" alt="shape" class="h q r" />
        <img src="{{asset('assets/images/hero.png')}}"    alt="Woman" class="h q r ua" />
      </div>
      ...
      <div class="bb ze ki xn 2xl:ud-px-0">
        <div class="tc _o">
          <div class="animate_left jn/2">
            <h1 class="fk vj zp or kk wm wb"> a platform for all, take up your skills</h1>
            <p class="fq">
            ...
            <div class="tc tf yo zf mb">
              <a href="{{route('signup')}}" class="ek jk lk gh gi hi rg ml il vc _d _l">Get Started Now on Adigmart-Fre</a>
        ...
        <div class="tc uf zo xf ap zf bp mq">
          ...
          <div class="animate_top kn to/3 tc cg oq">
            <div class="tc wf xf cf ae cd rg mh">
              <img src="{{asset('assets/images/icon-01.svg')}}" alt="Icon" />
            </div>
            <div>
          ...
          <div class="animate_top kn to/3 tc cg oq">
            <div class="tc wf xf cf ae cd rg nh">
              <img src="{{asset('assets/images/icon-02.svg')}}" alt="Icon" />
            </div>
            <div>
          ...
          <div class="animate_top kn to/3 tc cg oq">
            <div class="tc wf xf cf ae cd rg oh">
              <img src="{{asset('assets/images/icon-03.svg')}}" alt="Icon')}}" />
            </div>
            <div>
      ...
      <div class="bb ze ki xn wq">
        <div class="tc wf gg qq">
          ...
          <div class="animate_left xc gn gg jn/2 i">
            <div>
              <img src="{{asset('assets/images/shape-05.svg')}}" alt="Shape" class="h -ud-left-5 x" />
              <img src="{{asset('assets/images/about-01.png')}}" alt="About" class="ib" />
              <img src="{{asset('assets/images/about-02.png')}}" alt="About" />
            </div>
            <div>
              <img src="{{asset('assets/images/shape-06.svg')}}" alt="Shape" />
              <img src="{{asset('assets/images/about-03.png')}}" alt="About" class="ob gb" />
              <img src="{{asset('assets/images/shape-07.svg')}}" alt="Shape" class="bb" />
            </div>
          </div>
          ...
          <div class="animate_right jn/2">
            ...
            <a href="https://www.youtube.com/watch?v=xcJtL7QggTI" data-fslightbox class="vc wf hg mb">
              <span class="tc wf xf be dd rg i gh ua">
                ...
                <img src="{{asset('assets/images/icon-play.svg')}}" alt="Play" />
              </span>
    ...
    <section class="i pg ji gp uq">
      ...
      <img src="{{asset('assets/images/shape-08.svg')}}" alt="Shape Bg" class="h q r" />
      <img src="{{asset('assets/images/shape-09.svg')}}"alt="Shape" class="of h y z/2" />
      <img src="{{asset('assets/images/shape-10.svg')}}"alt="Shape" class="h _ aa" />
      <img src="{{asset('assets/images/shape-11.svg')}}"alt="Shape" class="of h m ba" />
        ...
        <div class="wc qf pn xo gg cp">
          ...
          <div class="animate_top rj">
            <div class="c i pg z-1">
              <img class="vd" src="{{asset('assets/images/team-01.png')}}" alt="Team" />
          ...
          <div class="animate_top rj">
            <div class="c i pg z-1">
              <img class="vd" src="{{asset('assets/images/team-02.png')}}" alt="Team" />
          ...
          <div class="animate_top rj">
            <div class="c i pg z-1">
              <img class="vd" src="{{asset('assets/images/team-03.png')}}" alt="Team" />
  ...
  <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
      ...
      <div class="bb ze ki xn yq mb en">
        <div class="wc qf pn xo ng">
          ...
          <div class="animate_top sg oi pi zq ml il am cn _m">
            <img src="{{asset('assets/images/icon-04.svg')}}" alt="Icon" />
          ...
          <!-- Service Item -->
          <div class="animate_top sg oi pi zq ml il am cn _m">
            <img src="{{asset('assets/images/icon-05.svg')}}" alt="Icon" />
          ...
          <!-- Service Item -->
          <div class="animate_top sg oi pi zq ml il am cn _m">
            <img src="{{asset('assets/images/icon-06.svg')}}" alt="Icon" />
          ...
          <!-- Service Item -->
          <div class="animate_top sg oi pi zq ml il am cn _m">
            <img src="{{asset('assets/images/icon-07.svg')}}" alt="Icon" />
    ...
    <section x-data="setup()" class="i pg fh rm ji gp uq">
      <!-- Bg Shapes -->
      <img src="{{asset('assets/images/shape-06.svg')}}" alt="Shape" class="h aa y" />
      <img src="{{asset('assets/images/shape-03.svg')}}" alt="Shape" class="h ca u" />
      <img src="{{asset('assets/images/shape-07.svg')}}" alt="Shape" class="h w da ee" />
      <img src="{{asset('assets/images/shape-12.svg')}}" alt="Shape" class="h p s" />
      <img src="{{asset('assets/images/shape-13.svg')}}" alt="Shape" class="h r q" />
        ...
        <div class="projects-wrapper tc -ud-mx-5">
          ...
          <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
            <div class="c i pg sg z-1">
              <img src="{{asset('assets/images/project-01.png')}}" alt="Project" />
          ...
          <div class="project-item wi fb vd jn/2 to/3 digital">
            <div class="c i pg sg z-1">
              <img src="{{asset('assets/images/project-02.png')}}" alt="Project" />
          ...
          <div class="project-item wi fb vd jn/2 to/3 branding ecommerce">
            <div class="c i pg sg z-1">
              <img src="{{asset('assets/images/project-04.png')}}" alt="Project" />
          ...
          <div class="project-item wi fb vd vo/3 digital ecommerce">
            <div class="c i pg sg z-1">
              <img src="{{asset('assets/images/project-03.png" alt="Project')}}" />
  ...
  <p class="bb on/5 wo/5 hq" x-text="sectionTitleText"></p>
              ...
              <div class="swiper-slide">
                <div class="i hh rm sg vk xm bi qj">
                  ...
                  <div class="tc sf rn tn un zf dp">
                    <img class="bf" src="{{asset('assets/images/testimonial.png')}}" alt="User" />

                    <div>
                      <img src="{{asset('assets/images/icon-quote.svg')}}" alt="Quote" />
                      ...
                      <div class="tc yf vf">
                        ...
                        <img class="rk" src="{{asset('assets/images/brand-light-02.svg')}}" alt="Brand" />
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <section class="i pg qh rm ji hp">
      <img src="{{asset('assets/images/shape-11.svg" alt="Shape')}}" class="of h ga ha ke" />
      <img src="{{asset('assets/images/shape-07.svg" alt="Shape')}}" class="h ia o ae jf" />
      <img src="{{asset('assets/images/shape-14.svg" alt="Shape')}}" class="h ja ka" />
      <img src="{{asset('assets/images/shape-15.svg" alt="Shape')}}" class="h q p" />
      ...
      <div class="bb ze ah ch pm hj xp ki xn 2xl:ud-px-49 bc">
        <div class="wc rf qn zf cp kq xf wf">
          <a href="#" class="rc animate_top">
            <img class="th wl ml il zl om" src="{{asset('assets/images/brand-light-01.svg')}}" alt="Clients')}}" />
            <img class="xc sk ml il zl nm" src="{{asset('assets/images/brand-dark-01.svg')}}" alt="Clients" />
          </a>
          <a href="#" class="rc animate_top">
            <img class="tk ml il zl om" src="{{asset('assets/images/brand-light-02.svg')}}" alt="Clients" />
            <img class="xc sk ml il zl nm" src="{{asset('assets/images/brand-dark-02.svg')}}" alt="Clients" />
          </a>
          <a href="#" class="rc animate_top">
            <img class="tk ml il zl om" src="{{asset('assets/images/brand-light-03.svg')}}" alt="Clients" />
            <img class="xc sk ml il zl nm" src="{{asset('assets/images/brand-dark-03.svg')}}" alt="Clients" />
          </a>
          <a href="#" class="rc animate_top">
            <img class="tk ml il zl om" src="{{asset('assets/images/brand-light-04.svg')}}" alt="Clients" />
            <img class="xc sk ml il zl nm" src="{{asset('assets/images/brand-dark-04.svg')}}" alt="Clients" />
          </a>
          <a href="#" class="rc animate_top">
            <img class="tk ml il zl om" src="{{asset('assets/images/brand-light-05.svg')}}" alt="Clients" />
            <img class="xc sk ml il zl nm" src="{{asset('assets/images/brand-dark-05.svg')}}" alt="Clients" />
          </a>
          <a href="#" class="rc animate_top">
            <img class="tk ml il zl om" src="{{asset('assets/images/brand-light-06.svg')}}" alt="Clients" />
            <img class="xc sk ml il zl nm" src="{{asset('assets/images/brand-dark-06.svg')}}" alt="Clients" />
          </a>
        </div>
      </div>
    </section>
        ...
        <div class="wc qf pn xo zf iq">
          ...
          <div class="animate_top sg vk rm xm">
            <div class="c rc i z-1 pg">
              <img class="w-full" src="{{asset('assets/images/blog-01.png')}}" alt="Blog" />
            ...
            <div class="yh">
              <div class="tc uf wf ag jq">
                <div class="tc wf ag">
                  <img src="{{asset('assets/images/icon-man.svg')}}" alt="User" />
                  <p>Musharof Chy</p>
                </div>
                <div class="tc wf ag">
                  <img src="{{asset('assets/images/icon-calender.svg')}}" alt="Calender" />
                  <p>25 Dec, 2025</p>
                </div>
              </div>
          ...
          <div class="animate_top sg vk rm xm">
            <div class="c rc i z-1 pg">
              <img class="w-full" src="{{asset('assets/images/blog-02.png')}}" alt="Blog" />
          ...
          <div class="animate_top sg vk rm xm">
            <div class="c rc i z-1 pg">
              <img class="w-full" src="{{asset('assets/images/blog-03.png')}}" alt="Blog" />
      ...
      <div class="i va bb ye ki xn wq jb mo">
        <div class="tc uf sn tf rn un zf xl:gap-10">
          <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
            <!-- Bg Shapes -->
            <img src="{{asset('assets/images/shape-03.svg')}}" alt="Shape" class="h la x wd" />
            <img src="{{asset('assets/images/shape-06.svg')}}" alt="Shape" class="h la ma ne kf" />
 ...
 <!-- Bg Shape -->
 <img class="h p q" src="{{asset('assets/images/shape-16.svg')}}" alt="Bg Shape" />
 ...
 <div class="bb ye i z-10 ki xn dr">
  <div class="tc uf sn tn un gg">
    ...
    <div class="animate_right bf">
        <a href="{{route('signup')}}"> Get Started Now </a>
    </div>
